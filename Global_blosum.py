...
for row in range(1, len(matrix)):                   
    for col in range(1, len(matrix[row])):
        ...
        diag = matrix[row-1][col-1] + blosum62[seq2[row-1]+seq1[col-1]]
